//Z67430S JOB (ACCT),'FAIL CASE',CLASS=A,MSGCLASS=A,NOTIFY=&SYSUID
//* Step 1 - Sort input file in descending order and remove duplicates
//STEP01   EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z67430.JCL.SORTIN3,DISP=SHR
//SORTOUT  DD DSN=Z67430.JCL.SORTOUT3,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z67430.JCL.SORTIN3,DISP=SHR
//TOOLIN   DD *
...
/*
//SYSUT2   DD DSN=Z67430.JCL.SORTOUT3,DISP=(NEW,CATLG,DELETE),
