//Z67430S JOB (ACCT),'SORT JOB',CLASS=A,MSGCLASS=A,NOTIFY=&SYSUID
//* Step 1 - Sort input file in descending order
//STEP01   EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z67430.JCL.SORTIN1,DISP=SHR
//SORTOUT  DD DSN=Z67430.JCL.SORTOUT1,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z67430.JCL.SORTIN1,DISP=SHR
//TOOLIN   DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN2      DD DSN=Z67430.JCL.SORTOUT1,DISP=SHR
//TOOLIN   DD *
...
//SORTOUT  DD DSN=Z67430.JCL.SORTOUT1,DISP=(MOD,DELETE,DELETE)
//*
